...
final class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingWithMapperError_displaysLocalizeErrorMessageAndStopsLoading() {
        let (sut, view) = makeSUT(mapper: { resource in
            throw anyNSError()
        })
    ...
    private func makeSUT(
        ...
        let view = ViewSpy()
        let presenter = SUT(resourceView: view, loadingView: view, errorView: view, mapper: mapper)
